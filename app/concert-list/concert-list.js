...
angular.module('ui.bootstrap.popup', ['ngAnimate', 'ngSanitize', 'ui.bootstrap']);
angular.module('ui.bootstrap.popup').controller('DatepickerPopupDemoCtrl', function ($scope) {
